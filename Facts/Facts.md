...
The password reset functionality allows to add a `role` parameter in the intercepted request. Setting the parameter to `admin` elevates the account to full administrator without authorization.
